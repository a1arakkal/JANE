...
#' \item{\code{p_k}}{ A numeric vector of length \eqn{K} representing the estimated mixture probabilities of the multivariate normal mixture distribution for the latent positions.}
