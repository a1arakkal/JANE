...
-  $\boldsymbol{F} = \text{Diag}(1/100, (1/2.5^2)\mathrm{\bf{1}}_{dim(\boldsymbol{\beta}_{LR})})$
-  $\boldsymbol{F}_2 = \text{Diag}(1/100, (1/2.5^2)\mathrm{\bf{1}}_{dim(\boldsymbol{\beta}_{GLM})})$
-  $\boldsymbol{G} = \mathrm{\bf{I}}_D$
-  $h = l =1$
-  $m_1 = m_2 = o_1 = o_2 = 2$
-  $\boldsymbol{\nu} = 3\mathrm{\bf{1}}_{K}$
