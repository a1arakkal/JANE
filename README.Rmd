...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/JANE)](https://CRAN.R-project.org/package=JANE)
...
JANE is a package to fit and simulate latent space network cluster models using an expectation-maximization algorithm.
